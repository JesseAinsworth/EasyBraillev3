...
import { ClassificationAnalyzer } from "@/components/ClassificationAnalyzer"
...
export default function ClassificationPage() {
  ...
  useEffect(() => {
    ...
    const checkAdminAccess = () => {
      ...
      if (!storedUser) {
        ...
        router.push("/login?redirectTo=/classification")
        return
      }
  ...
  return (
    <div className="container py-8 max-w-7xl">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Algoritmos de Clasificación</h1>
        <p className="text-muted-foreground">
          Herramientas avanzadas para análisis y clasificación de datos con algoritmos de machine learning
        </p>
